...
export default async function LocalizedHome({ params }: Props) {
  ...
  return (
    <main>
      ...
      <section className="section contact"><p className="eyebrow">{t.contact}</p><h2>{h.contactTitle}</h2><p>{h.contactText}</p><a className="button button-dark" href={mailtoHref()}>{business.email}</a></section>
    </main>
  );
}
