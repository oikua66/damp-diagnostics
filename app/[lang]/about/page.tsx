...
const about = {
  en: {
    ...
    blocks: [
      ...
      ['Management and project background', ['I have led engineering and construction-related businesses and project teams, including PulsAR-92 in Kharkiv.', 'My work has included technical specifications, procurement logic, contractor selection, project review, due diligence, energy systems, industrial facilities and practical problem solving in buildings.']],
  ...
  ru: {
    ...
    blocks: [
      ...
      ['Управление и проекты', ['Я руководил инженерными и строительными бизнесами и проектными командами, в том числе компанией PulsAR-92 в Харькове.', 'В моей практике — разработка технических заданий, логика закупок, выбор подрядчиков, проверка проектов, due diligence, энергетические системы, промышленные объекты и практические инженерные задачи в зданиях.']],
  ...
  uk: {
    ...
    blocks: [
      ...
      ['Управління та проєкти', ['Я керував інженерними й будівельними бізнесами та проєктними командами, зокрема компанією PulsAR-92 у Харкові.', 'У моїй практиці — технічні завдання, логіка закупівель, вибір підрядників, перевірка проєктів, due diligence, енергетичні системи, промислові об’єкти та практичні інженерні задачі у будівлях.']],
  ...
  sr: {
    ...
    blocks: [
      ...
      ['Upravljanje i projekti', ['Vodio sam inženjerske i građevinske firme i projektne timove, uključujući PulsAR-92 u Harkovu.', 'Moje iskustvo obuhvata tehničke zahteve, logiku nabavke, izbor izvođača, reviziju projekata, due diligence, energetske sisteme, industrijske objekte i praktično rešavanje tehničkih problema u zgradama.']],
